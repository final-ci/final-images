...
curl -L https://api.github.com/repos/travis-ci/travis-cookbooks/tarball/28a024a6e45d04ae495ebc8fe7a1cffc12f45c8b | tar xvf -
mv $TMP_DIRECTORY/travis-ci-travis-cookbooks-* $TMP_DIRECTORY/ttravis-cookbooks

sudo chef-solo -c $TMP_DIRECTORY/assets/solo.rb -j $TMP_DIRECTORY/tstandard_solo.json
